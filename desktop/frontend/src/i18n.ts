...
const strings = {
  // Navigation
  "nav.group.whitevpn": { en: "amhVPN", fa: "amhVPN" },
  ...
  "nav.source": { en: "Source: amhVPN Telegram", fa: "منبع: تلگرام ای ام اچ وی پی ان" },
  ...
  // The status card.
  "vpn.card.ready": { en: "amhVPN ready", fa: "amhVPN آماده است" },
  "vpn.card.ready.description": { en: "Runtime idle", fa: "موتور بی‌کار است" },
  "vpn.card.connecting": { en: "Connecting amhVPN", fa: "در حال اتصال amhVPN" },
  ...
  "vpn.card.connected": { en: "amhVPN connected", fa: "amhVPN متصل است" },
  "vpn.card.connected.description": {
    en: "Proxy listening on {endpoint}",
    fa: "پراکسی روی {endpoint} در حال شنود است",
  },
  "vpn.card.disconnecting": { en: "Disconnecting amhVPN", fa: "در حال قطع amhVPN" },
  ...
  "vpn.card.failed": { en: "amhVPN could not connect", fa: "amhVPN نتوانست وصل شود" },
  ...
  "vpn.card.otherRuntime.description": {
    en: "Disconnect the active runtime before starting amhVPN.",
  ...
  "backup.card.description": {
    en: "Export or restore all saved amhVPN profiles.",
    fa: "برون‌بری یا بازگردانی همهٔ پروفایل‌های ذخیره‌شدهٔ amhVPN.",
  },
  ...
  "nav.source.open": { en: "Open amhVPN Telegram channel", fa: "باز کردن کانال تلگرام amhVPN" },
